 ...
 */
public class KnockKoutInplannenController implements Initializable {
    private KnockKoutInplannenModel knockoutInplannenModel;
    ...
    public KnockKoutInplannenController(Toernooi toernooi, int deeltoernooinummer) {
        this.knockoutInplannenModel = new KnockKoutInplannenModel(toernooi, deeltoernooinummer);
    }
