...
import presentation.models.PouleKnockoutInplannenModel;
 ...
 */
public class PouleKInplannenController implements Initializable {
    private PouleKnockoutInplannenModel pouleInplannenModel;
    ...
    public PouleKInplannenController(Toernooi toernooi, int deeltoernooinummer) {
        this.pouleInplannenModel = new PouleKnockoutInplannenModel(toernooi, deeltoernooinummer);
    }
